<header>
    <div class="container header-section flex">
        <div class="header-left">
            <h1>
                Looking for a
                <p style="color: #ff9502; font-size: 3rem; margin-top: 10px">
            ...
            <div class="logo-panel flex">
                <div class="logo-box flex">
                    <div class="logo-layer">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" class="first" fill="orange" viewBox="0 0 448 512">
                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z" />
                        </svg>
                    </div>
                    <div class="small-bold-text logo-desc">
                        Easy and fast service
                    </div>
                </div>
                <div class="logo-box flex">
                    <div class="logo-layer">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="orange" class="first" viewBox="0 0 576 512">
                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        ...
        <div class="header-right">
            <img src="./assets/image/workman.jpg" alt="worker image" />
        </div>
    </div>
</header>